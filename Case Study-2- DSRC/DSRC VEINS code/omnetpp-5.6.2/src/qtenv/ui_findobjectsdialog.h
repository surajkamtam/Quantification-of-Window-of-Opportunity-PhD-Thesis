...
public:
    ...
    void retranslateUi(QDialog *FindObjectsDialog)
    {
        ...
        fullPathLabel->setText(QCoreApplication::translate("FindObjectsDialog", "Object full path filter, e.g. \"*.queue AND not length(0)\":", nullptr));
#if QT_CONFIG(tooltip)
        fullPathEdit->setToolTip(QCoreApplication::translate("FindObjectsDialog", "Generic filter expression which matches the object full path by default.\n"
"\n"
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        comboBox->setToolTip(QCoreApplication::translate("FindObjectsDialog", "Generic filter expression which matches class name by default.\n"
"\n"
