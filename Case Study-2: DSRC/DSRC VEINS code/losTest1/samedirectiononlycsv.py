...
if __name__ == "__main__":
    ...
    output_base_folder = "/home/suraj/Downloads/output_files_FDI_static_general_noattacklos70"
    initial_depart_value = 895
    final_depart_value = 896
    simulation_runs = 30
    #vehs_per_hour_values = [600,900,1000,1200,1400]
    vehs_per_hour_values = [1400]
    #config_names = ["PersistentAttack"]
    config_names = ["Noattack"]
