...
//    vehiclePosition->calculateHostPosition();
//    veins::Coord veinsCoord;

//    veinsCoord.x=curPostion();
//    veinsCoord.y=curPostion();
//    veinsCoord.z=curPostion();

//    veinsCoord.x=vehiclePosition.x;
//       veinsCoord.y=vehiclePosition.y;
//       veinsCoord.z=vehiclePosition.z;
//
//    std::cout<<"Position x"<<veinsCoord.x<<std::endl;
    ...
    else if (vehID == "vehicle_1"){
        secVehSpeed = mobility->getSpeed();
        std::cout<<"Vehicle 1 Speed:"<<secVehSpeed<<std::endl;
    }
