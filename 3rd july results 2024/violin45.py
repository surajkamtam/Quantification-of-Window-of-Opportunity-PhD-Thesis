...
combined_files_45 = ['combined_LOSA45.csv', 'combined_LOSB45.csv', 'combined_LOSC45.csv', 'combined_LOSD45.csv', 'combined_LOSE45.csv']

# Mapping between file names and labels for FFS 45 mph
file_labels_45 = {
    'combined_LOSA45.csv': 'LOS A',
    'combined_LOSB45.csv': 'LOS B',
    'combined_LOSC45.csv': 'LOS C',
    'combined_LOSD45.csv': 'LOS D',
    'combined_LOSE45.csv': 'LOS E'
}
...
ax = sns.violinplot(data=combined_df, x='File', y='Attacker Messages', hue='FFS', palette={'60 mph': 'green', '45 mph': 'blue'}, split=True)
plt.title('Attacker Messages for different LOS')
plt.xlabel('Level Of Service')
plt.ylabel('Attacker Messages')
...
for label, df_group in combined_df.groupby(['File', 'FFS']):
    ...
    above_threshold_45 = df_group[df_group['Attacker Messages'] > 45].shape[0]
    below_threshold_45 = df_group[df_group['Attacker Messages'] <= 45].shape[0]
